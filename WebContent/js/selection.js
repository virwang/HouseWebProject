...
//	for(var i = 0; i<district[index].length; i++){
//		document.myForm.selectcity.options[i] = new Option(district[index][i], district[index][i]);
//		document.mtForm.selectcity.length = district[index].length;
//	}
//	
//}

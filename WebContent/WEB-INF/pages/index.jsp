...
<body>
	...
	<div class="slide-one-item home-slider owl-carousel"
		...
		<div class="site-blocks-cover overlay"
			style="background-image: url(images/house1.jpg);" data-aos="fade"
		...
		<div class="site-blocks-cover overlay"
			style="background-image: url(images/house2.jpg);" data-aos="fade"
			data-stellar-background-ratio="0.5">
			<div class="container">
				<div
					class="row align-items-center justify-content-center text-center">
			...
			<div class="row">
				<div class="col-md-12">
					<div
						...
						<div class="mr-auto">
							<a href="index.html" class="icon-view view-module"><span
								class="icon-view_module"></span></a> <a href="view-list.html"
								class="icon-view view-list active"><span
				...
				<div class="col-md-12">
					<div class="property-entry horizontal d-lg-flex">
						...
						<a href="#" class="property-thumbnail h-100">
							...
							</div> <img src="images/house1.jpg" alt="Image" class="img-fluid">
						</a>
						...
						<div class="p-4 property-body">
							...
							<h2 class="property-title">
								<a href="#"> 231 新北市 新店區</a>
							</h2>
							<span class="property-location d-block mb-3"><span
								class="property-icon icon-room"></span> 231 新北市 新店區 北新路一段 79號</span> <strong
								class="property-price text-primary mb-3 d-block text-success">$65.2萬/坪</strong>
							<p>交通動線佳, 有休閒設施, 熱鬧商圈, 社區機能成型, 強調建築外觀, 社區統一管理, SRC結構, 自地自建,
								面臨主幹道或次要幹道, 鄰河川, 標準樓層。</p>
							<ul class="property-specs-wrap mb-3 mb-lg-0">
								<li><span class="property-specs">房間</span> <span
									class="property-specs-number">2 <sup>+</sup></span></li>
								<li><span class="property-specs">廳</span> <span
									class="property-specs-number">2</span></li>
								<li><span class="property-specs">坪數</span> <span
									class="property-specs-number">50</span></li>
							</ul>
						</div>
				...
				<div class="col-md-12">
					<div class="property-entry horizontal d-lg-flex">
						...
						<a href="#" class="property-thumbnail h-100">
							...
							</div> <img src="images/house6.jpg" alt="Image" class="img-fluid">
						</a>
						...
						<div class="p-4 property-body">
							<a href="#" class="property-favorite active"><span
								class="icon-heart-o"></span></a>
							<h2 class="property-title">
								<a href="#">116 台北市 文山區</a>
							</h2>
							<span class="property-location d-block mb-3"><span
								class="property-icon icon-room"></span> 116 台北市 文山區 木柵路 三段 85巷</span> <strong
							...
							<ul class="property-specs-wrap mb-3 mb-lg-0">
								<li><span class="property-specs">房</span> <span
									class="property-specs-number">2 <sup>+</sup></span></li>
								<li><span class="property-specs">廳</span> <span
									class="property-specs-number">1</span></li>
								<li><span class="property-specs">坪數</span> <span
									class="property-specs-number">20</span></li>
							</ul>
						</div>
					...
					<div class="property-entry horizontal d-lg-flex">
						...
						<a href="#" class="property-thumbnail h-100">
							<div class="offer-type-wrap">
								<span class="offer-type bg-danger">賣</span>
								<!-- <span class="offer-type bg-success">Rent</span> -->
							</div> <img src="images/house4.jpg" alt="Image" class="img-fluid">
						</a>
						...
						<div class="p-4 property-body">
							...
							<span class="property-location d-block mb-3"><span
								class="property-icon icon-room"></span> 853 S Lucerne 新店路263號-3
								六樓 6號</span> <strong
								class="property-price text-primary mb-3 d-block text-success">$2,265,500</strong>
							<p>新店捷運總站，到站即到家，鄰碧潭風景區，休閒運動好去處。公設齊全，管理佳，採光通風，遠看碧潭美景，生活機能佳</p>
							<ul class="property-specs-wrap mb-3 mb-lg-0">
								<li><span class="property-specs">房</span> <span
									class="property-specs-number">3 <sup>+</sup></span></li>
								<li><span class="property-specs">廳</span> <span
									class="property-specs-number">2</span></li>
								<li><span class="property-specs">坪</span> <span
									class="property-specs-number">50</span></li>
							</ul>
						</div>
					...
					<div class="property-entry horizontal d-lg-flex">
						...
						<a href="#" class="property-thumbnail h-100">
							<div class="offer-type-wrap">
								<span class="offer-type bg-danger">賣</span>
								<!-- <span class="offer-type bg-success">Rent</span> -->
							</div> <img src="images/house5.jpg" alt="Image" class="img-fluid">
						</a>
						...
						<div class="p-4 property-body">
							...
							<span class="property-location d-block mb-3"><span
								class="property-icon icon-room"></span> 231 新北市 新店區 央北二路</span> <strong
								class="property-price text-primary mb-3 d-block text-success">$2,265,500</strong>
							<p>央北重劃區東起中央路、南鄰中央新村、北至央北三路、西望溪園路，占地將近40公頃，設有一座中央公園及多處的小型鄰里公園，同時因緊鄰新店溪，另有小碧潭及陽光兩座既有河濱公園可利用。</p>
							<ul class="property-specs-wrap mb-3 mb-lg-0">
								<li><span class="property-specs">房</span> <span
									class="property-specs-number">4 <sup>+</sup></span></li>
								<li><span class="property-specs">廳</span> <span
									class="property-specs-number">3</span></li>
								<li><span class="property-specs">坪數</span> <span
									class="property-specs-number">80</span></li>
							</ul>
						</div>
					...
					<div class="property-entry horizontal d-lg-flex">
						...
						<a href="#" class="property-thumbnail h-100">
							<div class="offer-type-wrap">
								...
								<span class="offer-type bg-danger">賣</span>
							</div> <img src="images/house2.jpg" alt="Image" class="img-fluid">
						</a>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-7 text-center">
					...
					<p>
					<ul>
						<li><strong> 購屋流程說明: 為首次買房的您提供詳盡的說明 </strong></li>
						<li>看屋行程規劃: 省去您一個個輸入地址的麻煩</li>
					</ul>
					</p>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row justify-content-center mb-5">
				<div class="col-md-7 text-center">
					...
					<p>
						我們是一個五人團隊的團隊，來自各種不同的背景，平均年齡不到30歲。<br> <strong>因為資策會，所以我們相遇了。</strong>
					</p>
					<p>
						團隊裡面，有人曾經擔任過代書，有感於知名買賣租屋平台591及政府實價登入平台的複雜；<br>
						我們決定運用這四個月在資策會所學到的技能，創建一個更加平易近人、更簡化的購屋平台，<br>
						降低使用者在使用平台查詢相關訊息時所需的精力。<br>
					</p>
					<p>
						<strong>隨心而居，找到理想的房子!是我們的理念!</strong>
					</p>
				</div>
			</div>
					...
					<div class="accordion unit-8" id="accordion">
						<div class="accordion-item">
							<h3 class="mb-0 heading">
								<a class="btn-block" data-toggle="collapse" href="#collapseOne"
									role="button" aria-expanded="true" aria-controls="collapseOne">我們的團隊名稱:<span
									class="icon"></span></a>
							</h3>
						...
						<div class="accordion-item">
							<h3 class="mb-0 heading">
								<a class="btn-block" data-toggle="collapse"
									...
									aria-controls="collapseThree">為什麼要加入會員嗎? <span class="icon"></span></a>
							</h3>
							<div id="collapseThree" class="collapse"
								aria-labelledby="headingOne" data-parent="#accordion">
								<div class="body-text">
									<p>成為我們的會員後，可以使用【我的收藏】功能，將您感興趣的房屋加入收藏，並且可以上架房屋資訊、並且可透過問卷，配對最適合您的銀行房貸人員。</p>
								</div>
							</div>
						</div>
						<!-- .accordion-item -->
